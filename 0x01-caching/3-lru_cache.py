#!usr/bin/env python3
"""this module contains a clas that implements the lru type
of caching system"""
...
class LRUCache(BaseCaching):
    ...
    def put(self, key, item):
        ...
        if len(self.__cache_list) > self.MAX_ITEMS:
            print("DISCARD: {}".format(self.__cache_list[0]))
            del self.cache_data[self.__cache_list[0]]
            del self.__cache_list[0]
